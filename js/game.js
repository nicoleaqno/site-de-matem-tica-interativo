...
function novaPergunta() {
    ...
    const perguntarTexto = `${numeros.num1 } ${operacao} ${numeros.num2}`;

    respostaCorreta = calcularResposta(numeros.num1, numeros.num2, operacao);

    document.getElementById("ergunta").innerText = perguntarTexto;
...
// Caulcula o resultado com base nos números e operação
...
document.getElementById("resultado").innerText = pontuacao;
}